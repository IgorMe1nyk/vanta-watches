...
const COLLECTIONS = [
  {
    ...
    image: "/images/skeleton-noir.jpg",
    alt: "Openworked dress watch with a darkened skeleton dial",
    no: "01",
  },
  {
    name: "Helios",
    blurb: "Gold, in its element",
    image: "/images/movement-gold.jpg",
    alt: "Exposed golden watch movement, gears and bridges",
    no: "02",
  },
  {
    name: "Abyss",
    blurb: "Instruments for the deep",
    image: "/images/skeleton-azure.jpg",
    alt: "Skeleton watch with a blue-tinted openworked dial",
    no: "03",
  },
  {
    name: "Vector",
    blurb: "Speed, kept honest",
    image: "/images/macro-gears.jpg",
    alt: "Macro of a chronograph's brass gear train",
    no: "04",
  },
];
